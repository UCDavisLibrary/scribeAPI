...
HomePage = React.createClass
  ...
  render:->
     <div className="row homepage">
       ...
       <section className="small-12 medium-12 large-10 large-offset-1 columns title">

         <img className="large-title" src="/images/label-this-title-image.svg"/>
         <img className="small-title" src="/images/label-this-title-image-sm.svg"/>
       ...
       <section className="small-12 medium-10 medium-offset-1 large-8 large-offset-2 columns">         
    	 ...
    	 <section className="small-12 medium-12 large-10 large-offset-1 columns">
         <h1>Here’s how you can help:</h1>
          <div className="row">
            <div className="small-11 medium-expand columns step-by-step">
              <h6>Step 1: Mark</h6>
              <img className="step-image" src="/images/image-step-1.png"/>
              <p><small>Mark the areas on each label that will need transcribing or describing.</small></p>
            </div>
            <div className="small-11 medium-expand columns step-by-step">
              <h6>Step 2: Transcribe</h6>
              <img className="step-image" src="/images/image-step-2.png"/>
              <p><small>Mark the areas on each label that will need transcribing or describing.</small></p>
            </div>
            <div className="small-11 medium-expand columns step-by-step">
              <h6>Step 3: Describe</h6>
              <img className="step-image" src="/images/image-step-3.png"/>
              <p><small>Mark the areas on each label that will need transcribing or describing.</small></p>
            </div>
          </div>
       </section>
